...
//     try {
//       final ByteData startIconData = await rootBundle.load('asset/start.png');
//       final ByteData endIconData = await rootBundle.load('asset/end.png');
...
//     routeCoordinates = await _getRouteCoordinates(widget.startPoint, widget.endPoint) ?? [];
...
//     if (routeLine != null) {
//       await mapController.updateLine(routeLine!, LineOptions(geometry: routeCoordinates));
//     }
...
//       List<LatLng> interpolatedPoints = _interpolatePoints(start, end, interpolationSteps);

//       for (LatLng currentPosition in interpolatedPoints) {
//         await mapController.updateSymbol(startSymbol, SymbolOptions(geometry: currentPosition));

//         List<LatLng> updatedRoute = [currentPosition, ...routeCoordinates.sublist(i + 1)];
//         await mapController.updateLine(routeLine!, LineOptions(geometry: updatedRoute));

//         await Future.delayed(Duration(milliseconds: (stepDuration * 1000 / interpolationSteps).toInt()));
//       }
//     }
//   }
...
class _MapboxPicupSimulationState extends State<MapboxPicupSimulation>
  ...
  void _animateSymbolAlongRoute() async {
    ...
    // Trigger pulsing animation on reaching the end point
  ...
  void _triggerReachedAnimation() {
    ...
    text:'You have arrived at the pickup location. Please proceed with the pickup',
...
// class DropMapSimulation extends StatefulWidget {
//   final LatLng startPoint;
//   final LatLng endPoint;

//   const DropMapSimulation({
//     required this.startPoint,
//     required this.endPoint,
//     super.key,
//   });
...
//   @override
//   State<DropMapSimulation> createState() => _DropMapSimulationState();
// }


// class _DropMapSimulationState extends State<DropMapSimulation> {
//   static const String accessToken = 'pk.eyJ1IjoicmFodWw5ODA5IiwiYSI6ImNtM2N0bG5tYjIwbG4ydnNjMXF3Zmt0Y2wifQ.P4kkM2eW7eTZT9Ntw6-JVQ';
//   late MapboxMapController mapController;
//   late List<LatLng> routeCoordinates;
//   late Symbol startSymbol;
...
class _MapboxDropSimulationState extends State<MapboxDropSimulation>
  ...
  void _triggerReachedAnimation() {
    ReachedDialog.showLocationReachedDialog(context,
    title: 'Drop Location Reached!',
    text: 'You have arrived at the drop location. Please assist the passenger with the drop-off.',
    onConfirm: (){
