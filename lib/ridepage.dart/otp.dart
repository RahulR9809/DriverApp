...
import 'package:employerapp/ridepage.dart/ride_startpage.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

// class OtpRideStart extends StatefulWidget {
//   const OtpRideStart({super.key});
      ...
      body: BlocListener<RideBloc, RideState>(
        listener: (context, state) {
          if (state is RideStartedState) {
            ...
            // Pop the OTP page after starting the ride
Navigator.push(
  context,
  MaterialPageRoute(
...
// class OtpRideStartDialog extends StatelessWidget {
//   const OtpRideStartDialog({super.key});
...
//             SnackBar(content: Text('Ride started')),
//           );
//           // Close the dialog after starting the ride
...
//   const OtpInputForm({Key? key}) : super(key: key);
...
// void showOtpRideStartDialog(BuildContext context) {
//   showDialog(
//     context: context,
//     builder: (context) => const OtpRideStartDialog(),
//   );
// }
