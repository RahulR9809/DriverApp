...
//     return Scaffold(
//       backgroundColor: const Color.fromARGB(255, 255, 255, 255), // Dark background color
//       appBar: AppBar(
//         backgroundColor: Colors.deepPurple[800], // Unique dark color for app bar
//         elevation: 5,
//       leading: IconButton(
//   onPressed: () async {
...
//         child: Column(
//           children: [
//             // Profile Info Section with a sleek, modern design
//             Container(
...
//                 children: [
//                   CircleAvatar(
//                     radius: 70, // Larger profile image for a more striking look
...
//                   Text(
//                     name ?? 'Unknown Name',
//                     style: const TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 0, 0)),
//                   ),
...
//             // Profile Details with Cards having large icons and elevated styling
//             buildProfileCard(Icons.phone, 'Phone', phone ?? 'Not Provided'),
//             buildProfileCard(Icons.badge, 'License Number', licenseNumber ?? 'Not Provided'),
//             buildProfileCard(Icons.directions_car, 'Vehicle Type', vehicleType ?? 'Not Provided'),
//             buildProfileCard(Icons.article, 'Vehicle RC Number', vehicleRC ?? 'Not Provided'),
//             const SizedBox(height: 20),

//             // Image Cards for Documents with a polished, modern design
//             buildImageCard(context, 'License Image', licenseImg ?? ''),
//             buildImageCard(context, 'Vehicle Permit Image', vehiclePermit ?? ''),
//           ],
//         ),
//       ),
//     );
...
//   // Helper widget for profile items with larger icons and clean card design
// Widget buildProfileCard(IconData icon, String label, String value) {
//   return Card(
//     margin: const EdgeInsets.symmetric(vertical: 12),
//     color: const Color.fromARGB(255, 225, 224, 229), // Dark card background
//     shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15)),
//     elevation: 8,
//     child: ListTile(
//       leading: SizedBox(
//         width: 40,  // Constrain the width of the leading icon
//         height: 40, // Constrain the height of the leading icon
//         child: Icon(
//           icon,
...
//       title: Text(
//         label,
//         style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Color.fromARGB(255, 0, 0, 0)),
//       ),
//       subtitle: Text(
//         value,
//         style: const TextStyle(fontSize: 16, color: Color.fromARGB(179, 0, 0, 0)),
...
//   // Image Card for displaying documents with large icons and interactive dialog
// Widget buildImageCard(BuildContext context, String label, String imageUrl) {
...
//               Text(label, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.tealAccent)),
//             ],
//           ),
//         );
//       },
...
//       child: ListTile(
//         leading: SizedBox(
//           width: 60,  // Constrained width for the leading image
//           height: 60, // Constrained height for the leading image
//           child: ClipRRect(
...
//         title: Text(
//           label,
//           style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 16, color: Colors.tealAccent),
//         ),
//       ),
//     ),
//   );
